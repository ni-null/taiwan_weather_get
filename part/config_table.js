...
module.exports = {
    ...
    creat_conf_table: function () {
        ...
        return new Promise((resolve) => {
            ...
            pool.getConnection((err, connection) => {
                ...
                const sql = "CREATE TABLE `conf`" +
                    "(id INT AUTO_INCREMENT PRIMARY KEY,city_name VARCHAR(16),table_name VARCHAR(40),update_time VARCHAR(40))";
    ...
    original_data_seting_conf: function () {
        ...
        return new Promise((resolve) => {
            ...
            pool.getConnection((err, connection) => {
                ...
                const sql = "INSERT INTO `conf` (`city_name`, `table_name`, `update_time`) VALUES " +
                    data
    ...
    get_city_upadte_time_from_conf: function (city_name_che) {
    ...
    //更新時間
    upadte_data_time: function (update_time, city_name_che) {
        return new Promise((resolve) => {
